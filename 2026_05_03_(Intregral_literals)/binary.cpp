...
print(f"{x:b}")  # Returns '1010' instead of '0b1010'
print(y)         #it would return the binary represention of the x.
print(type(y))   #it would return 'str' because of the 0b (prefix).
My_binary_number = 0b11101101011001   #by using 0b prefix we tell PVM that it's a binary number not a decimal number. 
